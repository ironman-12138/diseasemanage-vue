        ...
        <el-card class="box-card">
            ...
            <template>
                ...
                >
                    ...
                    <el-table-column prop="deptCount" label="人数" sortable width="100">
                        <template slot-scope="scope">
                            <el-tag effect="plain" v-text="scope.row.deptCount+'人'" size="small">
                            </el-tag>
                        </template>
                    </el-table-column>
...
<script>
    import {findDept,add,edit,deleteById,update} from "@/api/dept";
    export default {
        data() {
        ...
        methods: {
            ...
            edit: async function (id) {
                edit(id).then(res => {
                    if (res.success) {
                        this.editRuleForm = res.data.dept;
                    } else {
            ...
            async getDepartmentList() {
                findDept(this.queryMap).then(res => {
                    console.log(res);
                    this.total = res.data.department.total;
                    this.departmentData = res.data.department.dataList;
                })
            },
            //改变页码
