...
<script>
    ...
    import {getRoleList,getMenuListById,authority,select,add,deleteById,update,updateStatus} from "@/api/role";
    export default {
        data() {
            return {
                btnLoading: false,
        ...
        methods: {
            ...
            async authority() {
                ...
                menuIds = menuIds + "";
                authority(this.grantId,menuIds).then(res => {
                    console.log(res);
                    if (res.success) {
            ...
            //加载用户列表
            async getRoleList() {
                getRoleList(this.queryMap).then(res => {
                    if (res.success) {
                        this.roleData = res.data.role.dataList;
                        this.total = res.data.role.total;
                    }
                })
            },
            //搜索
